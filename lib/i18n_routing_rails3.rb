    ...
    def localized_resources(type = :resources, *resources, &block)
      ...
      if @locales
        ...
        @locales.each do |locale|
          ...
          force_for_locale = options[:force] && options[:force].include?(locale)

          # A translated route exists :
          if (localized_path and localized_path != resource.name.to_s and String === localized_path) | force_for_locale
