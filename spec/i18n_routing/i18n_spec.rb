...
describe :localized_routes do
  ...
  context "i18n_locale_param" do
    before do
      I18nRouting.i18n_locale_param = :custom_locale_param

      $r = ActionDispatch::Routing::RouteSet.new
      $r.draw do
        scope '/:custom_locale_param', :constraints => {:custom_locale_param => /[A-Z]{3}/} do
          match '/about' => "about#show", :as => :custom_locale_param_about
        end
    ...
    it "should change the param name to the config options" do
      I18n.locale = :LOL
      routes.send(:custom_locale_param_about_path, I18n.locale).should == "/#{I18n.locale}/about"
    end
  end
